...
# ------------------------------
# Crear barras de color para cada subtipo
# ------------------------------
# Subtipo de cáncer detallado por muestra
...
subtype_colors = {
    ...
    # puedes agregar más subtipos si los hay
}
col_colors = sample_types['CANCER_TYPE_DETAILED'].map(subtype_colors)
# ------------------------------
# Crear gradiente naranja → morado oscuro
# ------------------------------
